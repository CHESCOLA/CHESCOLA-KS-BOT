...
module.exports = {
    VERSION: 'CHESCOLA 3.18v - Public Stable',
    SESSION: process.env.ASENA_SESSION === undefined ? '' : process.env.ASENA_SESSION,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.postimg.cc/63yKMTck/20210701-193912-01.jpg' : process.env.GAN_IMAGE,
    LANG: process.env.LANGUAGE === undefined ? 'TR' : process.env.LANGUAGE.toUpperCase(),
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'default' : process.env.ALIVE_MESSAGE,
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://i.postimg.cc/Gm636F8c/2021-07-07-19-32-26.jpg' : process.env.ALIVE_LOGO,
